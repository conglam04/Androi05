...
import com.example.todolist.Ui.setting.FaqAdapter;
import com.example.todolist.Ui.setting.FaqItem;
...
public class FaqActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        com.example.todolist.Ui.setting.FaqAdapter adapter = new FaqAdapter(faqList);
